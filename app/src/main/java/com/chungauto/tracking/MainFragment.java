...
//                        if (success) {
//                            Log.e("@@@@@", "Restart Services: " + newValue + "s");
...
//                    if (location == null) Log.e("@@@@@@", "Location null");
//                    else
...
//                });
    ...
    public void updateTimeInterval(String imei, int timeInterval) {
        Log.e("@@@@@@", "Update Device Id: " + imei);
        if (TextUtils.isEmpty(deviceId)) {
            deviceId = findPreference(KEY_DEVICE).getSummary().toString();
        }
        if (TextUtils.isEmpty(deviceId) || !deviceId.equals(imei)) return;
        Log.e("@@@@@@", "Update Time Interval: " + timeInterval);
        findPreference(KEY_INTERVAL).setSummary(String.valueOf(timeInterval));
        sharedPreferences.edit().putString(KEY_INTERVAL, String.valueOf(timeInterval)).commit();
        stopTrackingService();
        handler.removeCallbacksAndMessages(null);
        handler.postDelayed(() -> startTrackingService(true, false), 2000);
    }
...
//        findPreference(KEY_STATUS).setEnabled(false);
    ...
    public void updateDeviceId(String deviceId) {
        findPreference(KEY_DEVICE).setSummary(deviceId);
    }
